  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-1 gap-3 mb-8">
        {quickActions.map((action, index) => (
          <button
            ...
            className="p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors duration-150 text-left group active:scale-[0.98]"
          >
            <div className="flex items-start gap-3">
              <div className={`p-2 rounded-lg ${action.color} transition-colors duration-150 group-hover:opacity-90`}>
                {action.icon}
              </div>
              <div>
      ...
      <div className="mt-6 p-4 bg-linear-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg border border-blue-100 dark:border-blue-800/30">
        <div className="flex items-start gap-3">
          <HiChartBar className="w-5 h-5 text-blue-600 dark:text-blue-400 shrink-0 mt-0.5" />
          <div>
            <h4 className="font-medium text-blue-800 dark:text-blue-300 mb-1">
              Performance Tip
            </h4>
            <p className="text-sm text-blue-700 dark:text-blue-400">
              Focus on client satisfaction to increase renewal rates by 35%.
              Schedule follow-ups with active clients this week.
            </p>
          </div>
        </div>
      </div>
