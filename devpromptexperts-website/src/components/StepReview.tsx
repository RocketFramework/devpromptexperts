  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      <div>
        ...
        <p className="text-gray-600">Please review all information before submitting your Founder 100 application</p>
      </div>

      {/* Referral Banner - Show only if referral token exists */}
      {referralToken && (
