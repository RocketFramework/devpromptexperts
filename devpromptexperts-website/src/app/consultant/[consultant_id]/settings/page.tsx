...
import SettingsLayout from '@/components/consultant/SettingsLayout';
import ProfileSettings from '@/components/consultant/ProfileSettings';
import AccountSettings from '@/components/consultant/AccountSettings';
import NotificationSettings from '@/components/consultant/NotificationSettings';
import BillingSettings from '@/components/consultant/BillingSettings';
import TeamSettings from '@/components/consultant/TeamSettings';
import PrivacySettings from '@/components/consultant/PrivacySettings';
